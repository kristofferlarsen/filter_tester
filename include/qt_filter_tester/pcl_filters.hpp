...
public:
     ...
     */
    pcl::PointCloud<pcl::PointXYZRGB>::Ptr object_detection(pcl::PointCloud<pcl::PointXYZ>::Ptr cloud, std::vector<RayTraceCloud> model_a, std::vector<RayTraceCloud> model_b);
